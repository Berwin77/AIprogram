...
参考: 
[广告点击率预估模型---DIN的Tensorflow2.X代码分析](https://zhuanlan.zhihu.com/p/144153291)
[阿里DIN源码之如何建模用户序列（2）：DIN以及特征工程看法](https://zhuanlan.zhihu.com/p/112044156?ivk_sa=1024320u)