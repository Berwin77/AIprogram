...
@author: berwin learn from Ziyao Geng
"""
...
class DIN(Model):
    ...
    def call(self, inputs):
        ...
        # dense_inputs and sparse_inputs is empty
        # seq_inputs (None, maxlen, behavior_num) [,20,2]
        # item_inputs (None, behavior_num)        [,2]    => [target item,target cate]
        ...
        # 对有些历史记录不满 maxlen(这里设为为20) 的 进行遮挡 之前用pad_sequences 进行拉长时 空值填充0
        ...
        # 历史购买 item 以及cate  和 target的item和cate
        ...
        # concat user_info(att hist), cadidate item embedding, other features 拼接
